                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <form class="user">
                                    ...
                                    <a href="../assets/bootstrap/index.html" class="btn btn-primary btn-user btn-block">
                                        Login
                                    </a>
                                    <hr>
                                    <a href="../assets/bootstrap/index.html" class="btn btn-google btn-user btn-block">
                                        <i class="fab fa-google fa-fw"></i> Login with Google
                                    </a>
                                    <a href="../assets/bootstrap/index.html"
                                ...
                                <hr>
                                <div class="text-center">
                                    <a class="small" href="../assets/bootstrap/forgot-password.html">Forgot
                                        Password?</a>
                                </div>
                                <div class="text-center">
                                    <a class="small" href="../assets/bootstrap/register.html">Create an Account!</a>
                                </div>
                            </div>
                        </div>
                    </div>
